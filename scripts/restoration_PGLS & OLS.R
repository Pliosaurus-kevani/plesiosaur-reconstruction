...
SKL.aicc.p[1] <- SKL.aicc.p[1] + (2*3*4/33)
SKL.aicc.p[2] <- SKL.aicc.p[2] + (2*2*3/34)
...
rib.aicc[1] <- rib.aic[1]+(2*3*4/20)
rib.aicc[2] <- rib.aic[2]+(2*2*3/21)
...
tail.aicc[1] <- tail.aic[1] + (2*3*4/18)
tail.aicc[3] <- tail.aic[3] + (2*3*4/18)
tail.aicc[5] <- tail.aic[5] + (2*3*4/18)
tail.aicc[2] <- tail.aic[2] + (2*2*3/19)
tail.aicc[4] <- tail.aic[4] + (2*2*3/19)
tail.aicc[6] <- tail.aic[6] + (2*2*3/19)
...
SKL_plot <- 
  ...
  stat_function(fun= eq_LL, aes(color = "LL"), lwd = 1)+
