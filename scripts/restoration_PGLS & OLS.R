...
#there are two Kronosaurus samples in the dataset
#remove the one named "Kronosaurus_queenslandicus"
#since we only use MCZ 1285 here
...
eq_LL = function(x){(1.2838)/(1+((x/1.5883)^10.3988))-1.4494}
eq_PGLS = function(x){-1.423825*x+1.496674}
